...
.code
    ...
    ; c?digo a ser procesado
.startup
 
    ; Se imprime el texto de apoyo
    ; para el ingreso del n?mero
 
    lea dx, ingreso
    mov ah, 09h
    int 21h
 
    ; Se lee el valor num?rico en formato
    ; de caracter.
    mov ah, 01h
    int 21h
    ...
    ; apoyo.
    mov numero, al
    sub numero, 30h; Se convierte el valor de caracter en valor num?rico.
    ...
    cmp numero, 02h
    je Imp_Op2
    ; Se imprime el mensaje de n?mero invalido
